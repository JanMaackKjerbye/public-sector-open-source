...
Open source er en ideel løsning for det offentlige, ene og alene baseret på denne simple kendsgerning:

--- 

 **Offentlige udbydere af services er ikke i konkurrence med hinanden.** 
 
Denne grundlæggende virkelighed giver open source en unik mulighed for at fremme effektivitet, innovation, kvalitet og sikkerhed i det offentlige.
